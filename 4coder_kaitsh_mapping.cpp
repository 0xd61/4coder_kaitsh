// NOTE(dgl): Custom Keymapping

function void
KaitshSetCustomMapping(Mapping *mapping, i64 global_id, i64 file_id, i64 code_id)
{
    MappingScope();
    ...
    // NOTE(dgl): Additional file custom keybindings
    {
        ...
        Bind(kaitsh_cut_line, KeyCode_X, KeyCode_Control, KeyCode_Shift);
    }
